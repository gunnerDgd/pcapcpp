...
namespace pcapcpp::parser {
	...
	template <>
	bool is_upper_layer<protocol::arp_type> (ethernet::upper_protocol proto) { return (proto == ethernet::upper_protocol::arp)  ? true : false; }

	template <>
	bool is_upper_layer<protocol::ipv4_type>(ethernet::upper_protocol proto) { return (proto == ethernet::upper_protocol::ipv4) ? true : false; }
}